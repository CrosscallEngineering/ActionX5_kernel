...
#define UKL_SAFE_VOTER		"UKL_SAFE_VOTER"
#define UKL_SAFE_VOL_UV		(4350000 - 300000)
#define VBAT_MAX_VOL_UV		(4350000)
...
struct smb_charger {
	...
	struct delayed_work usbid_otg_work;
#endif
