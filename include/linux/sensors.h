...
#define NEAR_CODE	1
#define FAR_CODE	0
#define TOO_NEAR_CODE 2
#define COVERED_CODE 3
...
enum {
	...
	SENSOR_HANDLE_RGB = 42,
	SENSOR_HANDLE_SAR = 43,
};
...
enum {
	...
	PYSUEDO_SENSOR_TYPE_RGB			= 42,
	PYSUEDO_SENSOR_TYPE_SAR            = 43,
...
extern void sensors_report_3(struct input_dev *idev,
		int val_1, int val_2, int val_3, int val_4, int sensi, uint8_t *c_i);
